...
fichero = "C:/Users/Ernesto/Desktop/Runge-Kutta/Hprime.dat"

# --- Nombre del fichero de salida, correspondiente a la gráfica final en formato pdf ------
salida = "C:/Users/Ernesto/Desktop/Runge-Kutta/GraficaH.png"

# ----------- Nombre de las etiquetas de los ejes en el gráfico final ----------------------
set xlabel "i" # para la longitud  
set ylabel "H'" # para el cuadrado del periodO
...
plot [0:5000] [-2e09:8e09]  fichero with linespoints    lc rgb "red" ps 0 pt 7,  \
