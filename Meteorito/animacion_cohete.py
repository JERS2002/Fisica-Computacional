...
# Parámetros
# ========================================
file_in = "meteorito.dat" # Nombre del fichero de datos
file_out = "meteorito" # Nombre del fichero de salida (sin extensión)
...
planet_radius = [0.1, 0.1, 0.1, 0.1]
#planet_radius = [0.5, 0.7, 1.1]
color = ["black", "black","orange", "#277BAD"]
