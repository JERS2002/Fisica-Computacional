...
# Parámetros
# ========================================
file_in = "estabilidad_data.dat" # Nombre del fichero de datos
file_out = "planetasestabilidad" # Nombre del fichero de salida (sin extensión)
...
trail_width = 1.3 # Ancho de la estela
